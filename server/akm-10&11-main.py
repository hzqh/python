...
if __name__ == '__main__': 
    ...
    if rc_status==0:      
        ...
        rc_key_id_list=rc_packet.get_key_ id_list()
        ...
        if (rc_msg_typ == 110 and  rc_req_id == req_reqid and rc_key_typ == req_key_typ and  rc_key_num == req_key_num and rc_key_len == req_key_len and rc_get_typ == req_get_typ ):
    ...
    if rc_status==0:      
        ...
        if (rc_msg_typ == 110 and rc_req_id == req_reqid+1 and rc_key_typ == req_key_typ and  rc_key_num == req_key_num and rc_key_len == req_key_len and rc_get_typ == 1 ):
            print '*****req success***** and status is ',rc_status
            ack_packet=ackPacket.AckPacket()
            ack_packet.set_sess_key(ack_key)
            ack_packet.set_sess_key_id(ack_key_id)
